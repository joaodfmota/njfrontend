...
// used gulp-sass v2.3.2 Version because 3.x is getting error with sourcemaps
// see https://github.com/nodejs/help/issues/429
...
gulp.task('watch', function() {
  ...
  gulp.watch([path.source + 'images/svg/*.svg'], ['svg']);
  gulp.watch(['bower.json', 'assets/manifest.json'], ['build']);
  gulp.watch(['./dist/**/*', './lib/**/*', './templates/**/*', './*']);
